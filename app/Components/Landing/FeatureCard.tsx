...
const Index = () => {
  return (
    <div className="pb-24 lg:pb-32 bg-dark2 text-white">
      <div className="relative  w-full overflow-hidden">
        ...
        <div className="absolute inset-0 z-0  opacity-60">
          ...
          >
            <path
              d={`M0,${60 + 20} C100,${20 + 20} 200,${80 + 20} 300,${
                40 + 20
              } S400,${90 + 20} 500,${30 + 20} S600,${70 + 20} 700,${
                50 + 20
              } S800,${10 + 20} 900,${60 + 20} S1000,${40 + 20} 1100,${
                30 + 20
              } S1200,${70 + 20} 1300,${20 + 20}`}
          ...
          >
            <path
              ...
              className={cn(
                "graph-line fill-none",
                "stroke-crypto-ethereum/10"
              )}
              strokeWidth="2"
            />
          </svg>
          ...
          >
            <path
              d={`M0,${60 + 10} C100,${20 + 10} 200,${80 + 10} 300,${
                40 + 10
              } S400,${90 + 10} 500,${30 + 10} S600,${70 + 10} 700,${
                50 + 10
              } S800,${10 + 10} 900,${60 + 10} S1000,${40 + 10} 1100,${
                30 + 10
              } S1200,${70 + 10} 1300,${20 + 10}`}
              className={cn(
                "graph-line fill-none",
                "stroke-crypto-polkadot/10"
              )}
              strokeWidth="2"
            />
          </svg>
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 pt-16 md:pt-24 pb-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                  ...
                  <div className="feature-item flex items-center">
                    ...
                    <div className="font-light">
                      Blockchain Consulting With Your Business
                    </div>
                  </div>
                  <div className="feature-item flex items-center">
                    ...
                    <div className="font-light">
                      Kickstart your crypto own website today
                    </div>
                  </div>
                  <div className="feature-item flex items-center">
                    <div className="feature-icon mr-2 bg-light-sccuess rounded-full">
            ...
            <div className="relative flex justify-center lg:justify-center items-center">
              <div className="absolute m-6 inset-0 pointer-events-none">
                {/* Use Next.js Image for optimal loading. Ensure the bg-lines.svg file is in the public folder */}
                <Image
                  src="./lines.svg"
                  alt="Background lines"
                  fill
                  className ="object-cover  filter  hue-rotate-180"
                />
              </div>
              {/* Portfolio Card */}
              <div className="relative w-full max-w-sm rounded-lg bg-dark4/30 p-6  border backdrop-blur-sm  border-gray-700 shadow-lg">
                    ...
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 flex items-center justify-center rounded-full">
                        ...
                        >
                          ...
                          <path
                            d="M11.9977 4.5L11.8789 4.89727V14.8431L11.9977 14.9616L16.4927 12.2186L11.9977 4.5Z"
                            fill="white"
                            fillOpacity="0.6"
                          />
                          <path
                            d="M11.9977 4.5L7.50269 12.2186L11.9977 14.9616V10.089V4.5Z"
                            fill="white"
                          />
                          <path
                            d="M11.9977 15.9201L11.9312 16.0008V19.3945L11.9977 19.5893L16.4966 13.1787L11.9977 15.9201Z"
                            fill="white"
                            fillOpacity="0.6"
                          />
                          <path
                            d="M11.9977 19.5893V15.9201L7.50269 13.1787L11.9977 19.5893Z"
                            fill="white"
                          />
                          <path
                            d="M11.9977 14.9616L16.4927 12.2186L11.9977 10.089V14.9616Z"
                            fill="white"
                            fillOpacity="0.2"
                          />
                          <path
                            d="M7.50269 12.2186L11.9977 14.9616V10.089L7.50269 12.2186Z"
                            fill="white"
                            fillOpacity="0.6"
                          />
                        </svg>
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-xs text-gray-400">ETH/USD</span>
                      </div>
                    </div>
                    <div className="flex items-center gap-1 text-primary">
                      <span>1.50%</span>
                    ...
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 flex items-center justify-center rounded-full">
                        ...
                        >
                          ...
                          <path
                            d="M12.5046 5.25L9.16003 15.2069L6.99744 14.389L6.66089 15.5085L8.54635 16.2372L7.5 19.5H17.25L18 16.5H11.595L12.3766 14.0981L14.6768 14.9633L15.0123 13.8438L12.9758 13.0731L15.9726 5.25H12.5046Z"
                            fill="white"
                          />
                        </svg>
                      </div>
                      <div className="flex flex-col">
                        ...
                        <span className="text-xs text-gray-400">LTC/USD</span>
                      </div>
                    </div>
                    <div className="flex items-center gap-1 text-primary">
                      <span>3.05%</span>
                    ...
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 flex items-center justify-center rounded-full">
                        ...
                        >
                          ...
                          <path
                            d="M12 6C13.1046 6 14 6.89543 14 8C14 9.10457 13.1046 10 12 10C10.8954 10 10 9.10457 10 8C10 6.89543 10.8954 6 12 6Z"
                            fill="white"
                          />
                          <path
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-xs text-gray-400">DOT/USD</span>
                      </div>
                    </div>
                    <div className="flex items-center gap-1 text-primary">
                      <span>2.80%</span>
